...
loading this standalone mod. Test it alongside any other browser download or
context-menu customizations you use.
...
- Save `untitled.png` repeatedly and rapidly from two windows. Verify numbered
  ...
  Disable any automatic renaming feature for this naming check; re-enable it for
...
- Verify progress and completion in the browser download list, including any
  existing automatic renaming behavior when enabled.
...
- With your other browser customizations enabled, verify both menu actions and
  download-list behavior remain independent. Disable Quick Save Image and confirm
  the other customizations remain operational.
